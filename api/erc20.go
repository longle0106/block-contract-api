...
// IsSealed is a free data retrieval call binding the contract method 0x631f9852.
//
// Solidity: function isSealed() returns(bool)
func (_Token *TokenCaller) IsSealed(opts *bind.CallOpts) (bool, error) {
	var out []interface{}
	err := _Token.contract.Call(opts, &out, "isSealed")
...
//
// Solidity: function isSealed() returns(bool)
func (_Token *TokenSession) IsSealed() (bool, error) {
	return _Token.Contract.IsSealed(&_Token.CallOpts)
}

// IsSealed is a free data retrieval call binding the contract method 0x631f9852.
//
// Solidity: function isSealed() returns(bool)
func (_Token *TokenCallerSession) IsSealed() (bool, error) {
	return _Token.Contract.IsSealed(&_Token.CallOpts)
}

// LastMintedTimestamp is a free data retrieval call binding the contract method 0x7ba49b81.
//
// Solidity: function lastMintedTimestamp(address _owner) returns(uint32)
func (_Token *TokenCaller) LastMintedTimestamp(opts *bind.CallOpts, _owner common.Address) (uint32, error) {
	var out []interface{}
	err := _Token.contract.Call(opts, &out, "lastMintedTimestamp", _owner)
...
//
// Solidity: function lastMintedTimestamp(address _owner) returns(uint32)
func (_Token *TokenSession) LastMintedTimestamp(_owner common.Address) (uint32, error) {
	return _Token.Contract.LastMintedTimestamp(&_Token.CallOpts, _owner)
}

// LastMintedTimestamp is a free data retrieval call binding the contract method 0x7ba49b81.
//
// Solidity: function lastMintedTimestamp(address _owner) returns(uint32)
func (_Token *TokenCallerSession) LastMintedTimestamp(_owner common.Address) (uint32, error) {
	return _Token.Contract.LastMintedTimestamp(&_Token.CallOpts, _owner)
}
...
//
// Solidity: function totalSupply() returns(uint256 supply)
...
// Mint is a paid mutator transaction binding the contract method 0xb5e73249.
//
// Solidity: function mint(address _owner, uint256 _amount, bool _isRaw, uint32 timestamp) returns()
func (_Token *TokenTransactor) Mint(opts *bind.TransactOpts, _owner common.Address, _amount *big.Int, _isRaw bool, timestamp uint32) (*types.Transaction, error) {
	return _Token.contract.Transact(opts, "mint", _owner, _amount, _isRaw, timestamp)
}

// Mint is a paid mutator transaction binding the contract method 0xb5e73249.
//
// Solidity: function mint(address _owner, uint256 _amount, bool _isRaw, uint32 timestamp) returns()
func (_Token *TokenSession) Mint(_owner common.Address, _amount *big.Int, _isRaw bool, timestamp uint32) (*types.Transaction, error) {
	return _Token.Contract.Mint(&_Token.TransactOpts, _owner, _amount, _isRaw, timestamp)
}

// Mint is a paid mutator transaction binding the contract method 0xb5e73249.
//
// Solidity: function mint(address _owner, uint256 _amount, bool _isRaw, uint32 timestamp) returns()
func (_Token *TokenTransactorSession) Mint(_owner common.Address, _amount *big.Int, _isRaw bool, timestamp uint32) (*types.Transaction, error) {
	return _Token.Contract.Mint(&_Token.TransactOpts, _owner, _amount, _isRaw, timestamp)
}

// OfferBonus is a paid mutator transaction binding the contract method 0x534eb1d4.
//
// Solidity: function offerBonus(uint256 _bonus) returns()
func (_Token *TokenTransactor) OfferBonus(opts *bind.TransactOpts, _bonus *big.Int) (*types.Transaction, error) {
	return _Token.contract.Transact(opts, "offerBonus", _bonus)
}

// OfferBonus is a paid mutator transaction binding the contract method 0x534eb1d4.
//
// Solidity: function offerBonus(uint256 _bonus) returns()
func (_Token *TokenSession) OfferBonus(_bonus *big.Int) (*types.Transaction, error) {
	return _Token.Contract.OfferBonus(&_Token.TransactOpts, _bonus)
}

// OfferBonus is a paid mutator transaction binding the contract method 0x534eb1d4.
//
// Solidity: function offerBonus(uint256 _bonus) returns()
func (_Token *TokenTransactorSession) OfferBonus(_bonus *big.Int) (*types.Transaction, error) {
	return _Token.Contract.OfferBonus(&_Token.TransactOpts, _bonus)
}

// Seal is a paid mutator transaction binding the contract method 0x3fb27b85.
//
// Solidity: function seal() returns()
func (_Token *TokenTransactor) Seal(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Token.contract.Transact(opts, "seal")
}

// Seal is a paid mutator transaction binding the contract method 0x3fb27b85.
//
// Solidity: function seal() returns()
func (_Token *TokenSession) Seal() (*types.Transaction, error) {
	return _Token.Contract.Seal(&_Token.TransactOpts)
}

// Seal is a paid mutator transaction binding the contract method 0x3fb27b85.
//
// Solidity: function seal() returns()
func (_Token *TokenTransactorSession) Seal() (*types.Transaction, error) {
	return _Token.Contract.Seal(&_Token.TransactOpts)
}
...
func (_Token *TokenTransactor) SetOwner(opts *bind.TransactOpts, _newOwner common.Address) (*types.Transaction, error) {
	return _Token.contract.Transact(opts, "setOwner", _newOwner)
}

// SetOwner is a paid mutator transaction binding the contract method 0x13af4035.
//
// Solidity: function setOwner(address _newOwner) returns()
func (_Token *TokenSession) SetOwner(_newOwner common.Address) (*types.Transaction, error) {
	return _Token.Contract.SetOwner(&_Token.TransactOpts, _newOwner)
}

// SetOwner is a paid mutator transaction binding the contract method 0x13af4035.
//
// Solidity: function setOwner(address _newOwner) returns()
func (_Token *TokenTransactorSession) SetOwner(_newOwner common.Address) (*types.Transaction, error) {
	return _Token.Contract.SetOwner(&_Token.TransactOpts, _newOwner)
}
